...
1. **Clone the Repository** (skip if already cloned)
   ...
   - Paste the repository URL:
     ```
     https://github.com/RadaeePDF-Jugaad/RadaeePDF-Classic-iOS.git
     ```
...
2. **Open the Project**
   ...
   - Double-click on `PDFViewer.xcodeproj` to open the project in Xcode
...
3. Add the framework libRDPDFLib.a to your target's "Build Phases/Link Binary With Libraries"
...
- [Wiki](https://github.com/RadaeePDF-Jugaad/RadaeePDF-Classic-iOS/wiki)
